...
public class Casting1 {
    public static void main(String[] args) {
        ...
        * int -> long 을 비교해보면 long이 int보다 더 큰 숫자 범위를 표현한다.
        ...
        * 큰 그릇은 작은 그릇에 담긴 내용물을 담을 수 있다.*/

        /* 자동 형변환
        * 하지만 결국 대입하는 형(타입)을 맞추어야 하기 떄문에 개념적으로는 다음과 같이 동작한다.
        * //intValue = 10
        ...
        *
        * 이렇게 앞에 (double)과 같이 적어주면 int형이 double형으로 변한다.
        * 이렇게 형이 변경되는 것을 형변환이라 한다.
        * 작은 범위 숫자 타입에서 큰 범위 숫자 타입으로의 대입은 개발자가 이렇게 직접 형변환을 하지 않아도 된다.
        * 이런이 자동으로 일어나기 때문에 자동 형변환, 또는 묵시적 형변환이라 한다.*/
    }
}
